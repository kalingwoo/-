...
public class Test_obstacle {
	@Test
	public void testObstacleGetImage1() {
	...
	@Test
	public void testObstacleGetImage2() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
	...
	@Test
	public void testObstacleGetImage3() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
	...
	@Test
	public void testObstacleUpdate() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
	...
	@Test
	public void TestObstacleRenderable() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
	...
	@Test
	public void TestObstacleGetWidth() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
	...
	@Test
	public void TestObstacleGetHeight() {
		// Create a GameUI object
		GameUI gameUI = new GameUI();
